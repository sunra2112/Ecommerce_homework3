...
! function(t, e) {
    ...
    class Bn {
        ...
        getOptionScopes(t, e, i) {
            ...
            const r = new Set;
            e.forEach((e => {
                t && (r.add(t), e.forEach((e => Vn(r, t, e)))), e.forEach((t => Vn(r, n, t))), e.forEach((t => Vn(r, ut[o] || {}, t))), e.forEach((t => Vn(r, mt, t))), e.forEach((t => Vn(r, ft, t)))
            }));
            const l = [...r];
    ...
    class Gn {
        constructor(t, e) {
            ...
            const l = n.platform.acquireContext(o, r.aspectRatio),
                ...
                h = c && c.height,
                d = c && c.width;
            this.id = j(), this.ctx = l, this.canvas = c, this.width = d, this.height = h, this._options = r, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._sortedMetasets = [], this.scales = {}, this.scale = void 0, this._plugins = new On, this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = i((() => this.update("resize")), r.resizeDelay || 0), qn[n.id] = n, l && c ? (a.listen(n, "complete", $n), a.listen(n, "progress", Yn), n._initialize(), n.attached && n.update()) : console.error("Failed to create chart: can't acquire context from the given item")
        }
        get aspectRatio() {
            const {
                options: {
        ...
        buildOrUpdateScales() {
            ...
            i && (s = s.concat(Object.keys(i).map((t => {
                ...
                const s = i.options,
                    ...
                    r = Ln(a, s),
                    l = K(s.type, i.dtype);
                void 0 !== s.position && Hn(s.position, r) === Hn(i.dposition) || (s.position = i.dposition), o[a] = !0;
                let c = null;
        ...
        update(t) {
            ...
            e._minPadding = s, e._updateLayout(s), n || J(o, (t => {
                ...
                mode: t
            }), e._layers.sort(jn("z", "_idx")), e._lastEvent && e._eventHandler(e._lastEvent, !0), e.render()
        }
        _updateLayout(t) {
            const e = this;
        ...
        destroy() {
            ...
            t.config.clearCache(), e && (t.unbindEvents(), Xt(e, i), t.platform.releaseContext(i), t.canvas = null, t.ctx = null), t.notifyPlugins("destroy"), delete qn[t.id]
        }
        toBase64Image(...t) {
    ...
    function oo(t, e, i, n) {
        const o = t.iScale,
            ...
            l = [];
        let c, h, d, u;
        for (c = i, h = i + n; c < h; ++c) u = e[c], d = {}, d[o.axis] = r || o.parse(a[c], c), l.push(no(u, d, s, c));
        return l
    }
    ...
    class ao extends Ti {
        ...
        parseObjectData(t, e, i, n) {
            ...
            let d, u, f, g;
            for (d = i, u = i + n; d < u; ++d) g = e[d], f = {}, f[o.axis] = o.parse(lt(g, l), d), h.push(no(lt(g, c), f, s, d));
            return h
        }
        updateRangeFromParsed(t, e, i, n) {
    ...
    function _o(t, e) {
        const {
            ...
            innerStart: d,
            innerEnd: u
        } = xo(e, l, r, s - o), f = r - c, g = r - h, p = o + c / f, m = s - h / g, x = l + d, b = l + u, _ = o + d / x, y = s - u / b;
    ...
    function yo(t, e) {
        ...
        i.borderWidth && (n ? (t.lineWidth = 2 * i.borderWidth, t.lineJoin = "round") : (t.lineWidth = i.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function(t, e, i) {
            ...
            let h;
            for (i && (e.endAngle = e.startAngle + bt, mo(t, e), e.endAngle = a, e.endAngle === e.startAngle && (e.endAngle += bt, e.fullCircles--)), t.beginPath(), t.arc(n, o, c, s + bt, s, !0), h = 0; h < e.fullCircles; ++h) t.stroke();
        ...
        draw(t) {
            ...
            if (e.pixelMargin = "inner" === i.borderAlign ? .33 : 0, e.fullCircles = Math.floor(e.circumference / bt), !(0 === e.circumference || e.innerRadius < 0 || e.outerRadius < 0)) {
                ...
                t.fillStyle = i.backgroundColor, t.strokeStyle = i.borderColor,
                    function(t, e) {
                        if (e.fullCircles) {
                            e.endAngle = e.startAngle + bt, _o(t, e);
                            for (let i = 0; i < e.fullCircles; ++i) t.fill()
                        }
                        isNaN(e.circumference) || (e.endAngle = e.startAngle + e.circumference % bt), _o(t, e), t.fill()
                    }(t, e), yo(t, e), t.restore()
            }
        }
    }
    ...
    function Oo(t, e, i, n) {
        Co && 1 === e.segments.length ? function(t, e, i, n) {
            let o = e._path;
            o || (o = e._path = new Path2D, e.path(o, i, n) && o.closePath()), wo(t, e.options), t.stroke(o)
        }(t, e, i, n) : function(t, e, i, n) {
            const {
                segments: o,
                options: s
            } = e, a = Do(e);
            for (const r of o) wo(t, s, r.style), t.beginPath(), a(t, e, r, {
                start: i,
                end: i + n - 1
    ...
    function Xo(t) {
        return (t.scale || {}).getPointPositionForValue ? function(t) {
            ...
            let l, c, h;
            if (h = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(), n.grid.circular) return c = e.getPointPositionForValue(0, a), new Uo({
                x: c.x,
                y: c.y,
    ...
    function qo(t) {
        ...
        for (let t = 0; t < a.length; t++) {
            const e = a[t];
            for (let t = e.start; t <= e.end; t++) Go(s, r[t], l)
        }
        return new Ao({
            points: s,
            options: {}
    ...
    function ss(t, e) {
        ...
        for (const {
            ...
            t.save(), t.fillStyle = r, ns(t, a, es(o, c, h)), t.beginPath();
            ...
            const u = !!n.pathSegment(t, l, {
                ...
                f = d && u;
            f || os(t, n, c, o), t.closePath(), t.fill(f ? "evenodd" : "nonzero"), t.restore()
        }
    }
    ...
    function as(t, e, i) {
        ...
        n && o.points.length && (Gt(t, i), function(t, e) {
            ...
            t.save(), "x" === l && s !== o && (ts(t, n, a.top), ss(t, {
                line: i,
                target: n,
                color: o,
                scale: r,
                property: l
            }), t.restore(), t.save(), ts(t, n, a.bottom)), ss(t, {
                line: i,
                target: n,
                color: s,
                scale: r,
    ...
    var rs = {
        ...
        afterDatasetsUpdate(t, e, i) {
            const n = (t.data.datasets || []).length,
                o = [];
            let s, a, r, l;
            for (a = 0; a < n; ++a) s = t.getDatasetMeta(a), r = s.dataset, l = null, r && r.options && r instanceof Ao && (l = {
            ...
            for (a = 0; a < n; ++a) l = o[a], l && !1 !== l.fill && (l.fill = Jo(o, a, i.propagate))
        },
    ...
    class cs extends Ri {
        ...
        _draw() {
            ...
            const {
                ...
                boxHeight: b,
                itemHeight: _
            } = ls(l, g), y = t.isHorizontal(), v = this._computeTitleHeight();
            m = y ? {
    ...
    class ks extends Ri {
        ...
        getBody(t, e) {
            ...
            return J(t, (t => {
                const e = {
                    ...
                    s = Ms(n, t);
                gs(e.before, ps(s.beforeLabel.call(i, t))), gs(e.lines, s.label.call(i, t)), gs(e.after, ps(s.afterLabel.call(i, t))), o.push(e)
            })), o
        }
        getAfterBody(t, e) {
        ...
        _createItems(t) {
            const e = this,
                ...
                a = [];
            let r, l, c = [];
            for (r = 0, l = i.length; r < l; ++r) c.push(ms(e._chart, i[r]));
        ...
        drawTitle(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = vs(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Fe(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l) e.fillText(o[l], c.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + r, l + 1 === s && (t.y += i.titleMarginBottom - r)
            }
        }
        ...
        drawFooter(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = vs(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Fe(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r) e.fillText(o[r], l.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + i.footerSpacing
            }
        }
    ...
    class Bs extends Os {
        ...
        setDimensions() {
            const t = this;
            t.width = t.maxWidth, t.height = t.maxHeight, t.paddingTop = Ls(t.options) / 2, t.xCenter = Math.floor(t.width / 2), t.yCenter = Math.floor((t.height - t.paddingTop) / 2), t.drawingArea = Math.min(t.height - t.paddingTop, t.width) / 2
        }
        determineDataLimits() {
            const t = this,
                {
        ...
        generateTickLabels(t) {
            const e = this;
            Os.prototype.generateTickLabels.call(e, t), e._pointLabels = e.getLabels().map(((t, i) => {
        ...
        _setReductions(t, e, i) {
            ...
            o = Vs(o), s = Vs(s), a = Vs(a), r = Vs(r), n.drawingArea = Math.max(t / 2, Math.min(Math.floor(t - (o + s) / 2), Math.floor(t - (a + r) / 2))), n.setCenterPoint(o, s, a, r)
        }
    ...
    Bs.id = "radialLinear", Bs.defaults = {
        display: !0,
        animate: !0,
        position: "chartArea",
        angleLines: {
    ...
    function $s(t, e, i, n) {
        ...
        for (let s = Ns.indexOf(t); s < o - 1; ++s) {
            ...
            if (t.common && Math.ceil((i - e) / (o * t.size)) <= n) return Ns[s]
        }
        return Ns[o - 1]
    }
    ...
    class Xs extends Yi {
        ...
        buildTicks() {
            ...
            return t._unit = i.unit || (n.autoSkip ? $s(i.minUnit, t.min, t.max, t._getLabelCapacity(s)) : function(t, e, i, n, o) {
                for (let s = Ns.length - 1; s >= Ns.indexOf(i); s--) {
                    const i = Ns[s];
                    if (Ws[i].common && t._adapter.diff(o, n, i) >= e - 1) return i
                }
        ...
        _generate() {
            ...
            for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++) Ys(h, d, g);
        ...
        getLabelTimestamps() {
            ...
            const o = t.getLabels();
            for (i = 0, n = o.length; i < n; ++i) e.push(js(t, o[i]));
    ...
    Ks.id = "timeseries", Ks.defaults = Xs.defaults;
    ...
    return Gn.register(po, Gs, Ho, Ps), Gn.helpers = { ...Pn
